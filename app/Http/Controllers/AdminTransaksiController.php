...
class AdminTransaksiController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
		...
		$this->button_bulk_action  = TRUE;	
			...
			$this->col[] = ["label"=>"Customer","name"=>"id_customer","join"=>"customer,id"];
			$this->col[] = ["label"=>"Kode Transaksi","name"=>"kd_transaksi"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama','name'=>'nama','type'=>'select2','validation'=>'required','width'=>'col-sm-9'];
			...
			$this->form[] = ['label'=>'Start','name'=>'start','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
